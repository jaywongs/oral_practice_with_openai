from model.core import add_message, recognize_from_mic, synthesize_to_speaker, respond, concatenate, concatenate, suggestion
...
class ChatSession:
    def __init__(self, print_cmd = True, *args, **kwargs):
        ...
        self.respond_mod = "gpt-3.5-turbo"

        self.is_suggestion = False
        self.sugg_mod = "gpt-3.5-turbo"
    ...
    def _speak(self):
        ...
        self.conversation.append(add_message("user", my_paragraph))
    ...
    def _respond(self):
        ...
        self.conversation.append(add_message("assistant", ai_respond))
